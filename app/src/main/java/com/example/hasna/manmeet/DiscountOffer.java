...
public class DiscountOffer extends AppCompatActivity{
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        JSONArray jsonArray = getJSonData("discountOffer.json");
        final ArrayList<JSONObject> listItems = getArrayListFromJSONArray(jsonArray);
        ListView listV = (ListView) findViewById(R.id.listview);
        DiscountListAdapter discountListAdapter = new DiscountListAdapter(this, R.layout.discount_layout, R.id.txtCompany, listItems);
        listV.setAdapter(discountListAdapter);
